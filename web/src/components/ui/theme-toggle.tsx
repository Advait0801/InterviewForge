...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-3 py-1 text-sm text-text-primary transition hover:border-primary"
      type="button"
