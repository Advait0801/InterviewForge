...
export const PROBLEM_META: Record<string, ProblemMeta> = {
  ...
  "critical-connections-in-a-network": {
    ...
    params: [{ name: "n", type: "int" }, { name: "connections", type: "int[][]" }],
    returnType: "int[][]",
    unorderedOutput: true,
    unorderedInner: true,
  },
  "trapping-rain-water-ii": {
    ...
    params: [{ name: "heightMap", type: "int[][]" }],
    returnType: "int",
  },
  "the-skyline-problem": {
    className: "Solution",
    methodName: "getSkyline",
    params: [{ name: "buildings", type: "int[][]" }],
    returnType: "int[][]",
  },
  "number-of-digit-one": {
    className: "Solution",
    methodName: "countDigitOne",
    params: [{ name: "n", type: "int" }],
    returnType: "int",
  },
  ...
  "dungeon-game": {
    className: "Solution",
    methodName: "calculateMinimumHP",
    params: [{ name: "dungeon", type: "int[][]" }],
    returnType: "int",
  },
